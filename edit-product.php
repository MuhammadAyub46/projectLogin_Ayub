...
/* INI  KUNCINYA  */ margin-right:  auto; margin-left:  0;
...
value="<?= $product_edit['kode_barang'] ?? '' ?>" readonly>
<div  class="form-group">
<label>Nama  Barang</label>
<input type="text" name="nama_barang"
value="<?= $product_edit['nama_barang'] ?? '' ?>" required>
</div>
<div  class="form-group">
...
value="<?= $product_edit['harga'] ?? '' ?>" required>
<div  class="form-group">
<label>Stok</label>
<input type="number" name="stok"
value="<?= $product_edit['stok'] ?? '' ?>" required>
